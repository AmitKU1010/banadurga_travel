...
// party_name LIKE '%"."person_name"."%' AND `start_date` BETWEEN 'three_client' AND 'four_client'
  ...
  <table width="100%" border="1">
    <tr>
      ...
      <td>Amount In Figure Ruppees: Twenty Four Thousand  <br><p align="center"><b>THANK YOU</b></p><p align="center">Intrest @16% per annum will be charged on bills not paid within a week</p></td>
