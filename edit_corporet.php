...
$sqlone="UPDATE add_corporate SET cos_name='$cos_name',cos_adress='$cos_adress',cos_number='$cos_number',cos_email='$cos_email',cos_gst='$cos_gst' WHERE id='$getid'";
...
<?php 
$sql="SELECT * FROM `add_corporate` WHERE id='$getid'";
