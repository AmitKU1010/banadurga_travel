...
<body>
 ...
 $sql="INSERT INTO `cor_coustomer_carcharges`(`vehicle_id`,`vehicle_name`,`charging_type`,`day_charge`,`night_holt_charge`,`km_cover_in_one_litre`,`extra_hour_charges`,`price_per_km`,`detaintion_charges`) VALUES ('$vehicle_id','$vehicle_name','$charging_type','$day_charge','$night_holt_charge','$km_cover_in_one_litre','$extra_hour_charges','$price_per_km','$detaintion_charges')";
...
window.location ='carcharges_cor_coustomer.php';
    </script>
    <?php
  }
}
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Car Charges(Corporate Coustomer)</h6>
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View Car Charges(Corporate Coustomer)
</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM cor_coustomer_carcharges";
