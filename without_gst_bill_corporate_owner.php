...
<body>
  <table  width="100%" border="1" height="20%">
   ...
   <tr>
     <td colspan="3">
       ...
       Client Name :<?php echo $p_name=$data['cos_name'];?><br> <br>
       <?php 
  ...
  <table width="100%" border="1">
    <tr>
      <td>for <b>BANADURGA TRAVELS</b></td>
      <td>Amount In Figure :Ruppees Twenty Four Thousand  <br> <br><p align="center"><b>THANK YOU</b><br><b>Visit Again</b><br><p align="center"><!-- Intrest @16% per annum will be charged on bills not paid within a week --></p></td>
