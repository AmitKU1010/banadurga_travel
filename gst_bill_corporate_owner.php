...
// party_name LIKE '%"."person_name"."%' AND `start_date` BETWEEN 'three_client' AND 'four_client'
   ...
   $sql="SELECT * FROM update_dutyslip_corporate_owner WHERE id='$printid'";
...
<body>
  <table  width="100%" border="1" height="20%">
    <tr> 
   <td width="20%">Bill No :12</td>
   <td width="60%" align="center"><b>INVOICE</b><br>
  ...
  <b> Mobile:9437067889</b><br>
   ...
   <tr>
     <td colspan="3">
       ...
       <?php 
       $rr="SELECT * FROM coustomer WHERE cos_name='$p_name'";
  ...
  <table width="100%" border="1" height="20%" style="border-collapse: collapse;">
    <tr>
      ...
      <td align="center" rowspan="2"><strong>D.chrg</td></strong>
    ...
    <tr>
      ...
      <td align="center"><?php echo $data['grand_total'];?></td>
       <?php 
    $sei+=$data['grand_total'];
    $gst=$sei*5/100;
    $cgst=$sei*2.5/100;
    $sgst=$sei*2.5/100;
    $adv+=$data['advance'];

    $grand_total=$sei+$gst-$adv
    ?>
  ...
  <table width="100%" border="1">
    <tr>
      <td>for <b>BANADURGA TRAVELS</td>
      <td>Amount In Figure :Ruppees Twenty Four Thousand  <br> <br><p align="center"><b>THANK YOU</b><br><b>Visit Again</b></p><br><p align="center"><!-- Intrest @16% per annum will be charged on bills not paid within a week --></p></td>
      <td width="22%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL :<strong><?php echo $sei; ?> </strong><br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GST (5%) :<strong><?php echo $gst; ?><br></strong>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CGST (2.5%) : <strong><?php echo $cgst; ?>       </strong>  <br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SGST (2.5%) : <strong><?php echo $sgst; ?>       </strong>   <br> <br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(-)ADVANCE :  <strong><?php echo $adv; ?> </strong>    <br>
