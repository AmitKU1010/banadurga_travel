...
$sql="INSERT INTO `update_dutyslip_costomer_mst` (`bill_no`,`dutyslip_slno`,`party_name`,`place_from`,`report_at`,`vehicle_name`, `vehicle_id`, `vehicle_no`, `starting_date`, `starting_km`, `starting_time`, `closing_date`, `closing_km`, `closing_time`, `charging_type`, `total_km`, `total_time`, `nh_charges`, `no_of_nh`, `total_price_of_nh`, `detaintion_charges`, `detaintion_hour`, `total_price_of_detaintion`, `price_per_km`, `total_ppk`, `day_charge_td`, `km_cover_in_one_litre_td`, `fuel_rate_td`, `total_price_of_km_cover_in_one_lit_td`, `extra_parking_toll`, `total_amount`, `advance`, `grand_total`)
...
window.location ='update_dutyslip_tarini.php';
    </script>
    <?php
  }
}
