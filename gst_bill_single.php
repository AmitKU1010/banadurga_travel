...
// party_name LIKE '%"."person_name"."%' AND `start_date` BETWEEN 'three_client' AND 'four_client'
   ...
   $sql="SELECT * FROM update_dutyslip_costomer_mst WHERE id='$printid'";
...
<body>
  ...
  <center><img src="assets/images/logo.jpg" height="60px" width="80px"></center>
   ...
   <b><span><h3>BANADURGA TRAVELS</h3></span></b>
  ...
  <table width="100%" border="1">
    <tr>
      ...
      <td>Amount In Figure :<?php echo numberTowords("$grand_total");  ?> <br> <br><p align="center"><b>THANK YOU</b><br><b>Visit Again</b> </p><br><p align="center"><!-- Intrest @16% per annum will be charged on bills not paid within a week --></p></td>
