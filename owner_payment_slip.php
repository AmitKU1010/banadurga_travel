...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Vendor Payment</h6>
                    ...
                    $i = 1;
                     ...
                     <td>#<?php echo $i;?></td>
                      ...
                      <td class="text-nowrap">
                       ...
                       <a href="owner_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                       </i>
                     </a>
                      
                    <a href="bill_archieve_owner.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>

                     <a href="bill_archieve_withoutgst_owner.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true">
                    </i>
                     </a>
