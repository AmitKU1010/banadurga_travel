...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add DutySlip(corporate)</h6>
                              <hr class="light-grey-hr"/>
                            </div>
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="ajax_submit_dutyslip_corporate.php" method="post">
               <!-- row start -->
                         <div class="row">
                          <div class="col-md-4">
                    <div class="form-group">
                    <label class="control-label mb-10">Corporates</label>
                  ...
                  <select  name="corporate_name" class="form-control" >
                   ...
                   while($fetch=mysqli_fetch_assoc($run))
                     {
                      ?>
              <option value="<?php echo $fetch['id']."$".$fetch['name'];?>">
                 <?php echo $fetch['name']; ?>   </option>
                      <?php } ?>
              </select>
            ...
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM duty_slip_corporate";
                    ...
                    $i = 1;
                     ...
                     <td>#<?php echo $i;?></td>
                      ...
                      <td class="text-nowrap">
                         <a href="dutyslip_corporate_archieve.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
                            </a>
