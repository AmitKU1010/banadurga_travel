...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           ...
                           <div class="form-body">
                              ...
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Update DutySlip(Customer)</h6>
                              <form method="post" >
                              <table>
                                <tr>
                                  <td>
                              ...
                              <strong>Date Wise:</strong>
                                <select name="select_datewise" id="select_datewise" class="myselectdate">
                                   ...
                                   <?php 
                              $sq2="SELECT * FROM issue_dutyslip group by date";
                              $ru2=mysqli_query($conn,$sq2);
                              while($data2=mysqli_fetch_assoc($ru2)) 
                              {
                                ?>
      ...
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="update_dutyslip_banadurga.php" method="post" >
    ...
    SELECT update_dutyslip_costomer_mst.dutyslip_slno FROM  update_dutyslip_costomer_mst
                                                    )";
                        }
    ...
    SELECT update_dutyslip_costomer_mst.dutyslip_slno FROM  update_dutyslip_costomer_mst
                    ...
                    <input type="text" style="text-align:center;width:50px;background-color: #af1dba;color:#fff;" name="report_at[]" id="report_at-<?php echo $i; ?>" value="<?php echo $data5['report_at'] ?>">
                        ...
                        <td>
                          ...
                          <input type="hidden" style="text-align:center;width:90px;background-color: #af1dba;color:#fff;" name="party_name[]"  id="party_name-<?php echo $i; ?>" value="<?php echo $data5['party_name'] ?>">
                        </td>
                        ...
                        <td>
                          <input type="date" style="text-align:center;width:150px;background-color: #af1dba;color:#fff;" name="date[]" id="date-<?php echo $i; ?>" value="<?php echo $data5['date'] ?>" readonly>
                        </td>
                            ...
                            if(isset($_POST['submit_client']))
                              {
                                 ...
                                 $_SESSION['serach'] = $person_name;
                                  ...
                                  $sql = "SELECT * FROM `update_dutyslip_costomer_mst`  WHERE 
                                    party_name LIKE '%"."$person_name"."%' AND `starting_date` BETWEEN '$three_client' AND '$four_client'";
                                   
                              }
                              else
                              {
                    $sql = "SELECT * FROM update_dutyslip_costomer_mst";
                              }
                    ...
                    $i = 1;
                      ...
                      ?>
                        <td class="text-nowrap" style="text-align:center;width:80px;background-color:black;color:#fff;">
                         <a href="gst_bill_single.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
                            </a>
                            <a href="without_gst_bill_single.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>

                            <a href="delete_cos_bill.php?printid=<?php echo $v1['id']?>"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close  text-danger"></i> </a> 
                            </a>
                        <!--     
                        <a href="edit_car_details.php?eid=<?php echo $row['id']?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
                         ...
                         <a href="delete_car_details.php?eid=<?php echo $row['id']?>"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close  text-danger"></i> </a>  -->
                              ...
                              <td style="text-align:center;width:80px;background-color: #af1dba;color:#fff;"><?php echo $v1['advance_price'];?></td>
...
// function show_grand_total_amt(str)
//        {
//         var id = str;
...
// var y1q1Val = parseFloat($('#total_amount').val());
// var y1q2Val = parseFloat($('#advance_price').val());
// var y1q3Val = parseFloat($('#total_amount').val());
// var newVal = y1q2Val - y1q1Val + y1q3Val;

// $('#grand_total').val(newVal);        
     ...
     function show_closing_km(str)
       {
          ...
          $('#closing_time'+'-'+id_no[1]).keyup(function()
                          ...
                          // alert('yrs');
                           ...
                           var startdt = new Date($('#date'+'-'+id_no[1]).val()+ " " + $('#starting_time'+'-'+id_no[1]).val());
                           // alert(startdt);
      ...
      // alert(charging_type);
           ...
           jQuery.ajax
                      ({
                        ...
                        var advance_price=obj1[0].advance_price;
                           ...
                           var diff = enddt - startdt;
                                ...
                                $('#detaintion_hour'+'-'+id_no[1]).val(detaintion_hours);
                                 ...
                                 else
                                 {
                                   ...
                                   // alert(detaintion_hours);
                                $('#detaintion_hour'+'-'+id_no[1]).val(detaintion_hours);
                                 }
                                
                                // var kur=$('#detaintion_hour'+'-'+id_no[1]).val();
                                // var mur=$('#detaintion_charges'+'-'+id_no[1]).val();
                                // alert(kur);
                                // alert(mur);
