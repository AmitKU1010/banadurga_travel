...
echo $extra_km_charges=$_POST['extra_km_charges']; 
 ...
 $duplicate="SELECT * FROM corporate_charges WHERE charging_type='$daybasic' AND cos_name='$cos_name'";
...
{
$sql="INSERT INTO corporate_charges(`cos_id`, `cos_name`, `charging_type`, `day_charge`, `night_holt_charge`, `km_cover_in_one_litre`, `fixed_price`, `extra_hour_charges`, `extra_km_charges`, `price_per_km`, `detaintion_charges`) 
