...
$sql_r="SELECT * FROM corporate_owner_payment_slip WHERE id='$printid'";
...
<body>
<table width="1220"  border="1" style="border-collapse: collapse;" align="center">
  <tr>
    <td colspan="6" align="center"><h2>OWNER PAYMENT SLIP</h2> </td>
  </tr>
  <tr>
...
<br />
  ...
  <?php
  $sql="SELECT corporate_owner_payment_slip.id,duty_slip_corporate.report_at,duty_slip_corporate.booked_by from duty_slip_corporate INNER JOIN corporate_owner_payment_slip ON duty_slip_corporate.dutyslip_slno=corporate_owner_payment_slip.duty_slip_no WHERE corporate_owner_payment_slip.id='$printid'";
 ...
 <?php } ?>
  ...
  <tr>
   ...
   <tr>
    ...
    <td colspan="6"><p>&nbsp;</p>
    <p>&nbsp; </p>
    <p align="right">FOR TAKE OUR TRIP,PURI</p></td>
  </tr>
</table>
</body>
</html>
