...
$sql="SELECT * FROM issue_dutyslip WHERE id='$printid'";
...
<body>
  ...
  <!-- <table>
    <tbody>
      ...
      <tr>
        <td width="10%"><img src="assets/images/logo.jpg" height="75px" width="180px"></td>
        <td width="80%" align="center"> DUTYSLIP <br>
  ...
  (we make your travel fun,safe,economical,informative,comfortable & memorable)<br>
   ...
   <td width="10%">Mobile:9437067889<br></td> 
...
<table width="100%" border="1">
   ...
   <td width="20%"><b>Time & K.M.will be charged from travels to travels</b></td>
 ...
 <!-- <td colspan="14" height="10" align="center"><b>Thank You !</b><br><a>Visit Again</a></td> -->
