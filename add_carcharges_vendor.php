...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Car Charges(Owner)</h6>
...
<!-- hggggggggggggggggggggggggggggggggggggggggggfddddddddddsfsdfsdfdasf -->
                              <tr>
                                ...
                                <td>
                                    ...
                                    <label class="control-label mb-10">Daybasic</label>
...
<!-- hbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View Car Charges(Owner)</div>
            <div class="card-body">
              ...
              <table id="example" border="7" style="border-color: blue;">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM ownercarcharges order by cos_name";
...
else
{
           ...
           $.ajax({
                type:"post",
                url:"ajax_insert_owner_charges.php",
...
else
{
           ...
           $.ajax({
                type:"post",
                url:"ajax_insert_owner_charges_daybasic.php",
                dataType:"html", // Data type, HTML, json etc.
...
if(fixed_price=='')
{
  temp=1;
   alert('WHAT YOU ARE DOING??PLEASE INSERT SOME VALUE');
           ...
           $.ajax({
                type:"post",
                url:"ajax_insert_owner_charges_fixed.php",
                dataType:"html", // Data type, HTML, json etc.
