...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add Car Charges(Customer)</h6>
            ...
            <div class="card-body">
              ...
              <table id="example" border="7" style="border-color: blue;">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM customercarcharges order by cos_name";
  ...
  temp=1;
   alert('WHAT YOU ARE DOING??PLEASE INSERT SOME VALUE');
          ...
          else
          {
           $.ajax({
                type:"post",
                url:"ajax_insert_cos_charges.php",
...
else
{
           ...
           $.ajax({
                type:"post",
                url:"ajax_insert_cos_charges_daybasic.php",
                dataType:"html", // Data type, HTML, json etc.
  ...
  temp=1;
   alert('WHAT YOU ARE DOING??PLEASE INSERT SOME VALUE');
          ...
          else
          {
           ...
           $.ajax({
                type:"post",
                url:"ajax_insert_cos_charges_fixed.php",
                dataType:"html", // Data type, HTML, json etc.
