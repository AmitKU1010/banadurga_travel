    ...
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           ...
                           <div class="form-body">
                              ...
                              <button class="btn btn-danger"><a href="add_carcharges_vendor.php"> <strong>Edit Charges</strong></a></button>

                            </div>
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Update DutySlip(Owner)</h6>
                              <form method="post" >
                              <table>
                                <tr>
                                  <td>
                              <strong>Updated By :</strong>
                              <select name="updated_by" id="kuku" class="myselect">
                              ...
                              <strong>Choose Party Name :</strong>
                                ...
                                <select name="select_party_name" id="select_party_name" class="myselectpn">
                                  <option selected disabled>Choose Party Name</option>
                                   <?php 
                              $sq1="SELECT * FROM coustomer";
                              ...
                              <strong>Choose Vehicle Number :</strong>
                                <select name="select_vehicle_no" id="select_vehicle_no" class="myselectvn">
                                   ...
                                   <?php 
                              $sq2="SELECT * FROM vehicle_details";
                              ...
                              <strong>Dutyslip No :</strong>
                               <select name="select_dutyslip_no" id="select_dutyslip_no" class="myselectdn">
                                   ...
                                   <?php 
                              $sq2="SELECT * FROM issue_dutyslip";
                              $ru2=mysqli_query($conn,$sq2);
                              while($data2=mysqli_fetch_assoc($ru2)) 
                              {
                                ?>
                              ...
                              {
                                ?>
                                <option><?php echo $data2['starting_date']; ?></option>
                                <?php
                              }
                              ?>
                              </select>
      ...
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="update_dutyslip_owner.php" method="post" >
                ...
                <table>
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center;display: none;">Party Name</th>
    ...
    <th style="text-align: center;display: none;">Extra(p,t,o)</th>
                    ...
                    <tbody>
                     ...
                     echo $select_party_name=$_POST['select_party_name'];
                        ...
                        $sq5="SELECT issue_dutyslip.* FROM issue_dutyslip WHERE issue_dutyslip.party_name='$select_party_name'  AND issue_dutyslip.dutyslip_slno not in (
    SELECT update_dutyslip_owner_mst
.dutyslip_slno FROM  update_dutyslip_owner_mst
                     ...
                     $select_vehicle_no=$_POST['select_vehicle_no'];
                        // $sq5="SELECT * FROM issue_dutyslip WHERE vehicle_no='$select_vehicle_no'";
                         ...
                         $sq5="SELECT issue_dutyslip.* FROM issue_dutyslip WHERE issue_dutyslip.vehicle_no='$select_vehicle_no'  AND issue_dutyslip.dutyslip_slno not in (
    SELECT update_dutyslip_owner_mst
.dutyslip_slno FROM  update_dutyslip_owner_mst
                      ...
                      $select_dutyslip_no=$_POST['select_dutyslip_no'];
                        ...
                        $sq5="SELECT issue_dutyslip.* FROM issue_dutyslip WHERE issue_dutyslip.dutyslip_slno='$select_dutyslip_no'  AND issue_dutyslip.dutyslip_slno not in (
    SELECT update_dutyslip_owner_mst
.dutyslip_slno FROM  update_dutyslip_owner_mst
                     ...
                     $select_datewise=$_POST['select_datewise'];
                        ...
                        $sq5="SELECT issue_dutyslip.* FROM issue_dutyslip WHERE issue_dutyslip.starting_date='$select_datewise'  AND issue_dutyslip.dutyslip_slno not in (
    SELECT update_dutyslip_owner_mst
.dutyslip_slno FROM  update_dutyslip_owner_mst
                    ...
                    <input type="text" style="text-align:center;width:50px;background-color: #af1dba;color:#fff;" name="report_at[]" id="report_at-<?php echo $i; ?>" value="<?php echo $data5['report_at'] ?>">
                        ...
                        <td>
                          <input type="text" style="text-align:center;width:80px;background-color: #af1dba;color:#fff;" name="total_amount[]" id="total_amount-<?php echo $i; ?>" >
                        </td>

                        <td>
                          <input type="text" style="text-align:center;width:80px;background-color: #af1dba;color:#fff;" name="advance[]"  id="advance-<?php echo $i; ?>" value="<?php echo $data5['advance_price'] ?>">
                        </td>

                        <td>
                          <input type="text" style="text-align:center;width:80px;background-color: #af1dba;color:#fff;" name="driver_charge[]" id="driver_charge-<?php echo $i; ?>" >
                        </td>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View dutyslip
              <div class="table-wrap">
                   ...
                   <input type="submit" name="submit_client">
                    <a class="btn btn-info" target="_blanks" href="print_cos_owner.php">GST</a>
                    <a class="btn btn-info" target="_blanks" href="print_cos_withoutgst_owner.php">NON-GST</a>
            ...
            <div class="card-body">
              ...
              <table id="example" border="5" style="border-color: blue;" >
                ...
                <thead>
                  <tr>
                              ...
                              <th style="text-align: center">Adv</th>
                              <th style="text-align: center">D.chrg</th>
                            ...
                            if(isset($_POST['submit_client']))
                              {
                                 ...
                                 $_SESSION['serach'] = $person_name;
                                  ...
                                  $sql = "SELECT * FROM `update_dutyslip_owner_mst`  WHERE 
                                    party_name LIKE '%"."$person_name"."%' AND `starting_date` BETWEEN '$three_client' AND '$four_client'";
                                   
                              }
                              else
                              {
                    $sql = "SELECT * FROM update_dutyslip_owner_mst";
                              }
                    ...
                    $i = 1;
                      ...
                      ?>
                        <td class="text-nowrap" style="text-align:center;width:80px;background-color:black;color:#fff;">
                         <a href="gst_bill_single_owner.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
                            </a>
                            <a href="without_gst_bill_single_owner.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
                            </a>

                            <a href="delete_owner_bill.php?printid=<?php echo $v1['id']?>"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close  text-danger"></i> 
                        <!--     
...
<script>
     ...
     $('#total_time'+'-'+id_no[1]).on('blur', function()
       ...
       var vehicle_id=$('#vehicle_id'+'-'+id_no[1]).val();
       // alert(vehicle_id);
                         ...
                         // alert(detaintion_charges);
                          ...
                          if(charging_type=='long')
                          {
                           ...
                           var diff = enddt - startdt;
                             ...
                             $('#Driver_charge_id'+'-'+id_no[1]).on('change', function()
                             {
                                    
                              var grand_total=$('#total_amount'+'-'+id_no[1]).val()-$('#advance_price'+'-'+id_no[1]).val()+$('#Driver_charge_id'+'-'+id_no[1]).val();
    ...
    $('#total_amount'+'-'+id_no[1]).val(toatl_amount_without_adv_daybasic);
                             ...
                             $('#advance'+'-'+id_no[1]).on('change', function()
                             {
                              var grand_total=$('#total_amount'+'-'+id_no[1]).val()-$('#advance'+'-'+id_no[1]).val();
