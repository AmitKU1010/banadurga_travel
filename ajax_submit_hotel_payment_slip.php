...
$hotel_name = $_POST['hotel_name'];
  ...
  $sql="INSERT INTO `hotel_payment_slip`( duty_slip_no,
    duty_date,
    place_from,
    journey_to,
    booked_by,
  ...
  remark,
  noofnight_halt) 
  VALUES('$duty_slip_no','$duty_date','$place_from','$journey_to','$booked_by','$customer_gst',
  '$hotel_name','$vehicle_name','$vehicle_no','$starting_km','$closing_km','$total_km','$starting_time','$closing_time','$total_time','$charging_type','$fixed_price_f',
  '$extra_hour_new_f',
  '$extra_hour_price_f',
  '$t_e_h_p_f',
  '$extra_km_f',
...
window.location ='hotel_payment_slip.php';
    </script>
    <?php
  }
}
