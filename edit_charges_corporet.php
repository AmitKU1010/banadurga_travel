...
$sqlone="UPDATE corporate_charges SET cos_name='$cos_name',charging_type='$charging_type',day_charge='$day_charge',night_holt_charge='$night_holt_charge',km_cover_in_one_litre='$km_cover_in_one_litre',
...
<?php 
$sql="SELECT * FROM `corporate_charges` WHERE id='$getid'";
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Edit Charges Corporate</h6>
