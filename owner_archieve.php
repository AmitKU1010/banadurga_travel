...
<br />
  ...
  <?php
  $sql="SELECT owner_payment_slip_new.id,duty_slip.report_at,duty_slip.booked_by from duty_slip INNER JOIN owner_payment_slip_new ON duty_slip.dutyslip_slno=owner_payment_slip_new.duty_slip_no WHERE owner_payment_slip_new.id='$printid'";
