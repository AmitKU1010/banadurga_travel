...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add DutySlip(Hotel)</h6>
                              <hr class="light-grey-hr"/>
                            </div>
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="ajax_submit_dutyslip_hotel.php" method="post">
               <!-- row start -->
                         <div class="row">
                              <div class="col-md-3">
                          ...
                          while($fetch=mysqli_fetch_assoc($run))
                                    {
                                    ?>
                                      <option value="<?php echo $fetch['hotel_name']; ?>"><?php echo $fetch['hotel_name']; ?></option>
                                      <?php } ?>
                                    </select>
                                      <span class="help-block"> </span>
                                    </div>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View dutyslip(Hotel)</div>
            <div class="card-body">
              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM duty_slip_hotel";
                    ...
                    $i = 1;
                     ...
                     <td>#<?php echo $i;?></td>
                      ...
                      <td class="text-nowrap">
                        ...
                        <a href="dutyslip_archieve_hotel.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
                        </a>
