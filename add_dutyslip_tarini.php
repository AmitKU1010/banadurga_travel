    ...
    <div class="container-fluid">
      ...
      <!-- Model Start -->
          ...
          <div class="card" style="overflow: scroll;">
             <div class="card-body">
              <form action="ajax_submit_dutyslip_tarini.php" method="post">
                <table width="100%" id="data_table_add_product">
                    ...
                    <tbody >
                      <tr class="table-align" id="POITable">
                        <td>
                          <input type="text" style="text-align:center;width:40px;background-color: #af1dba;color:#fff;" name="sl_no[]"  id="sl_no-1" value="1"  >
                        </td>

                        <td>
                          <input type="text" style="text-align:center;width:80px;background-color: #af1dba;color:#fff;" name="dutyslip_slno[]" id="dutyslip_slno-1" maxlength="7" >
                        </td>

                        
                        <td>
                          <select style="width:120px;background-color: #af1dba;color:#fff;" name="party_name[]" onchange="show_unit(this.id)" id="party_name-1" class="party_name_clss">
                          ...
                          <td>
                          <input type="text" style="text-align:center;width:80px;background-color: #af1dba;color:#fff;" name="nature_of_duty[]" id="nature_of_duty-1" maxlength="7" >
                          </td>

                        <td>
                          <input type="text" style="width:110px;background-color: #af1dba;color:#fff;" name="address[]" id="address-1" class="address_clss" >
                          
                        </td>

                    <td>
                          <select style="width:120px;background-color: #af1dba;color:#fff;" name="vehicle_name[]" id="vehicle_name-1" onchange="show_type(this.id)" class="vehicle_name_clss">
                          ...
                          <td>
                          <select style="width:110px;background-color: #af1dba;color:#fff;" name="vehicle_no[]" id="vehicle_no-1" class="vehicle_no_clss" >
                          </select>
                        </td>
                        ...
                        <td>
                          <input type="text" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="starting_km[]" id="starting_km-1" maxlength="7" >
                        </td>

                        <td>
                          <input type="time" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="starting_time[]" id="starting_time-1" >
                        </td>

                        <td>
                          <input type="text" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="place_from[]" id="place_from-1" >
                        </td>

                         <td>
                          <input type="text" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="advance_price[]" id="advance_price" >
                        </td>
...
<script>
  ...
  z++;
    ...
    $('.add_tr').replaceWith('<tr class="table-align" id="data_table_td_0"><td><input type="text" style="text-align:center;width:40px;background-color: #af1dba;color:#fff;" name="sl_no[]" value="'+z+'" id="sl_no-'+z+'"</td><td><input type="text"style="text-align:center;width:80px;background-color: #af1dba;color:#fff;" name="dutyslip_slno[]" id="dutyslip_slno-'+z+'"</td><td><select style="width:120px;background-color: #af1dba;color:#fff;" name="party_name[]" onchange="show_unit(this.id)" id="party_name-'+z+'"class="party_name_clss"><option>Choose Party Name</option></select></td><td><input type="text" style="text-align:center;width:80px;background-color: #af1dba;color:#fff;" name="nature_of_duty[]" id="nature_of_duty-'+z+'"</td><td><input type="text" style="text-align:center;width:108px;background-color: #af1dba;color:#fff;" name="address[]" id="address-'+z+'"</td><td><select style="width:120px;background-color: #af1dba;color:#fff;" name="vehicle_name[]" onchange="show_type(this.id)" id="vehicle_name-'+z+'" class="vehicle_name_clss"><option>Choose Vehicle</option></select><td><select style="width:110px;background-color: #af1dba;color:#fff;" name="vehicle_no[]" id="vehicle_no-'+z+'"class="vehicle_no_clss"></td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="booked_by[]" id="booked_by-'+z+'"</td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="driver_name[]" id="driver_name-'+z+'"</td><td><input type="date" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="startig_date[]" id="startig_date-'+z+'"</td><td><input type="text" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="starting_km[]" id="starting_km-'+z+'"</td><td><input type="time" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="starting_time[]" id="starting_time-'+z+'"</td><td><input type="text" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="place_from[]" id="place_from-'+z+'"</td><td><input type="text" style="text-align:center;width:120px;background-color: #af1dba;color:#fff;" name="advance_price[]" id="advance_price-'+z+'"</td><td><a id="addrow-'+z+'" class="btn btn-info add-row mr-15" data-toggle="tooltip" data-original-title="Add Product"> <i class="fa fa-pencil text-inverse m-r-10"></i></a></td></tr><tr class="add_tr"></tr>');
    return false;
    });
