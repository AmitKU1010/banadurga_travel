...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <!-- Model Start -->
                           <div class="form-body">
                              <h6 align="center" class="txt-dark" style="font-size:15px;" ><i class="zmdi zmdi-account mr-10"></i>Add DutySlip(Corporet)</h6>
                              <hr class="light-grey-hr"/>
                            </div>
      
          <div class="card" style="overflow: scroll;">
             <div class="card-body">
              <form action="ajax_submit_dutyslip_corporet.php" method="post">
                <table width="100%" id="data_table_add_product">
                    ...
                    <tbody >
                      <tr class="table-align" id="POITable">
                        <td>
                          <input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="sl_no[]"  id="sl_no-1" value="1"  >
                        </td>
                        ...
                        <td>
                          <select style="width:160px;background-color: #af1dba;color:#fff;" name="party_name[]" onchange="show_unit(this.id)" id="party_name-1" class="party_name_clss">
                            <option>Choose Name</option>
                                      <?php 
                                      $query="SELECT *  from add_corporate ORDER BY cos_name";
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>View dutyslip(Corporate)</div>
            <div class="card-body">
              ...
              <table id="example" border="7" style="border-color: blue;" width="100%" height="40%">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM dutyslip_corporate";
                    ...
                    $i = 1;
                      ...
                      <td  style="text-align:center;width:80px;background-color: black;color:#fff;"class="text-nowrap">
                         <a href="dutyslip_archieve_corporet.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
                            </a>
...
<script>
  ...
  z++;
    ...
    $('.add_tr').replaceWith('<tr ><th style="text-align:center;" >ID</th><th style="text-align:center;">Slip No.</th><th style="text-align:center;">party Name</th><th style="text-align:center;">Nature of Duty</th><th style="text-align:center;">Address</th><th style="text-align:center;">Vehicle Name</th><th style="text-align:center;">Vehicle No.</th><th style="text-align:center;">Booked by</th></tr><tr class="table-align" id="data_table_td_0"><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="sl_no[]" value="'+z+'" id="sl_no-'+z+'"</td><td><input type="text" style="text-align:center;width:160;background-color: #af1dba;color:#fff;" name="dutyslip_slno[]" id="dutyslip_slno-'+z+'"</td><td><select style="width:160px;background-color: #af1dba;color:#fff;" name="party_name[]" onchange="show_unit(this.id)" id="party_name-'+z+'"class="party_name_clss"><option>Choose Party Name</option></select></td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="nature_of_duty[]" id="nature_of_duty-'+z+'"</td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="address[]" id="address-'+z+'"</td><td><select style="width:160px;background-color: #af1dba;color:#fff;" name="vehicle_name[]" onchange="show_type(this.id)" id="vehicle_name-'+z+'" class="vehicle_name_clss"><option>Choose Vehicle</option></select><td><select style="width:160px;background-color: #af1dba;color:#fff;" name="vehicle_no[]" id="vehicle_no-'+z+'"class="vehicle_no_clss"></td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="booked_by[]" id="booked_by-'+z+'"</td></tr><tr><th style="text-align:center;">Driver Name</th><th style="text-align:center;">Driver No.</th><th style="text-align:center;">Date</th><th style="text-align:center;">St.k.m</th><th style="text-align:center;">St.Time</th><th style="text-align:center;"></th><th style="text-align:center;">Advance</th></tr><tr><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="driver_name[]" id="driver_name-'+z+'"</td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="driver_number[]" id="driver_number-'+z+'"</td><td><input type="date" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="startig_date[]" id="date-'+z+'"</td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="starting_km[]" id="starting_km-'+z+'"</td><td><input type="time" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="starting_time[]" id="starting_time-'+z+'"</td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="place_from[]" id="place_from-'+z+'"</td><td><input type="text" style="text-align:center;width:160px;background-color: #af1dba;color:#fff;" name="advance_price[]" id="advance_price-'+z+'"</td><td><a id="addrow-'+z+'" class="btn btn-info add-row mr-15" data-toggle="tooltip" data-original-title="Add Product"> <i class="fa fa-pencil text-inverse m-r-10"></i></a></td></tr><tr class="add_tr"></tr>');
    return false;
    });
