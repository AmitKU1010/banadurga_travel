...
$sqlone="UPDATE customercarcharges SET cos_name='$cos_name',charging_type='$charging_type',day_charge='$day_charge',night_holt_charge='$night_holt_charge',km_cover_in_one_litre='$km_cover_in_one_litre',
