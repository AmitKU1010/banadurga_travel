  ...
  <b><span><h3>BANADURGA TRAVELS</h3></span></b><br>
   ...
   <tr>
     <td colspan="3">
       ...
       Tel No :<?php echo $fetch['cos_number']; ?><br><br>
       Coustomer GSTIN :<?php echo $fetch['cos_gst']; ?>
    ...
    <?php
     ...
     //         party_name LIKE '%"."$person_name"."%' AND `start_date` BETWEEN '$three_client' AND '$four_client' group by dutyslip_slno order by vehicle_name";
       ...
       $sql = "SELECT * FROM `update_dutyslip_costomer_mst`  WHERE 
             party_name LIKE '%"."$person_name"."%' AND `starting_date` BETWEEN '$three_client' AND '$four_client' group by dutyslip_slno order by dutyslip_slno";
