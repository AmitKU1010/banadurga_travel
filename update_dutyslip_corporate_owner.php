  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="col-lg-12">
          <div class="card">
             <div class="card-body">
              <form action="update_dutyslip_owner_corporate.php" method="post" >
            ...
            <div class="card-header"><i class="fa fa-table"></i>View dutyslip
              <div class="table-wrap">
                   ...
                   <input type="submit" name="submit_client">
                    <a class="btn btn-info" target="_blanks" href="print_cos_corporate_owner.php">GST</a>
                    <a class="btn btn-info" target="_blanks" href="print_cos_withoutgst_corporate_owner.php">NON-GST</a>
                      ...
                      <?php
                        $three_cor = $four_cor =  "";                   
                            if(isset($_POST['submit_client']))
                              ...
                              {
                    $sql = "SELECT * FROM update_dutyslip_corporate_owner";
                              }
                    ...
                    $i = 1;
                      ...
                      ?>
                        <td class="text-nowrap" style="text-align:center;width:80px;background-color:black;color:#fff;">
                         <a href="gst_bill_corporate_owner.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>
                            </a>
                            <a href="without_gst_bill_corporate_owner.php?printid=<?php echo $v1['id']; ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>

                            <a href="delete_corporate_owner_bill.php?printid=<?php echo $v1['id']?>"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-close  text-danger"></i> </a> 
                            </a>
                        <!--     
